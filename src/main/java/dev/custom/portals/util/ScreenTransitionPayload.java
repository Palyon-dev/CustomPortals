...
public record ScreenTransitionPayload(Boolean isTransitioning) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, ScreenTransitionPayload> CODEC = PacketCodec.tuple(PacketCodecs.BOOL, ScreenTransitionPayload::isTransitioning, ScreenTransitionPayload::new);
    @Override
