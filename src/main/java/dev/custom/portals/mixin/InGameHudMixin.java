...
public abstract class InGameHudMixin extends DrawableHelper {
    ...
    /*@Unique
    private void renderCustomPortalOverlay(float f, int color) {
        if (f < 1.0F) {
            f *= f;
            f *= f;
            f = f * 0.8F + 0.2F;
    ...
    public void renderMixin(InGameHud hud, float f) {
        renderCustomPortalOverlay(f, ((EntityMixinAccess)this.client.player).getPortalColor());
    }*/
}
